	...
	extends controller
	{
        ...
        public function findMenu($menuSubMenu){
            ...
            if (
                ...
                $page=0;  
            echo json_encode($this->model->findMenu($menuSubMenu,$page,27)["data"]);
        }
		...
		public function __construct(){
	        ...
	        if(issetParameter(noticiasDAO::titulo))                     $params[noticiasDAO::titulo]=getParameter(noticiasDAO::titulo);
