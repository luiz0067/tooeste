<?php
	...
	extends controller
	{
	    ...
	    public function findSlideShow($menuSubMenu){
            ...
            echo json_encode($this->model->findSlideShow($menuSubMenu)["data"]);		
        }
        public function findMenuAlbum($menuSubMenu){
            ...
            if (
                ...
                $page=0;  
            echo json_encode($this->model->findMenuAlbum($menuSubMenu,$page,27)["data"]);
        }
		...
		public function __construct(){
	        ...
	        if(arrayKeyExistsParameter(albumVideosDAO::nome))$params[albumVideosDAO::nome]=getParameter(albumVideosDAO::nome);
